...
[`@aws-sdk/client-appfabric`](https://www.npmjs.com/package/@aws-sdk/client-appfabric/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appfabric@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3RrEu4EKcM+k4dj9KysH2+GT9NPEJujincDqeI3FSrcO0MOW/R50ESyEdZwrGBCt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appfabric": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appfabric@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appfabric@3.514.0/index.min.mjs": "sha384-3RrEu4EKcM+k4dj9KysH2+GT9NPEJujincDqeI3FSrcO0MOW/R50ESyEdZwrGBCt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appfabric/blob/refs/tags/3.514.0/LICENSE
```
