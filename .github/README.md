...
[`@aws-sdk/client-appfabric`](https://www.npmjs.com/package/@aws-sdk/client-appfabric/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appfabric@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c5Pb8WtahHnrJIdRvPF+kBHb7Xj8WdHdAS8TqBnMixRFgMbyJCkoKMLd3APgiush
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appfabric": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appfabric@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appfabric@3.864.0/index.min.mjs": "sha384-c5Pb8WtahHnrJIdRvPF+kBHb7Xj8WdHdAS8TqBnMixRFgMbyJCkoKMLd3APgiush"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appfabric/blob/refs/tags/3.864.0/LICENSE
```
